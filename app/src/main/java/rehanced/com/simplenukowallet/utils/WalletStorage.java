...
import rehanced.com.simplenukowallet.data.FullWallet;
...
public class WalletStorage {
    ...
    public void importingWalletsDetector(MainActivity c) {
        ...
        File[] wallets = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Nekonium/").listFiles();
        if (wallets == null) {
    ...
    private boolean exportWallet(Activity c, boolean already) {
        ...
        if (ExternalStorageHandler.hasPermission(c)) {
            File folder = new File(Environment.getExternalStorageDirectory(), "Nekonium");
