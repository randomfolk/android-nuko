        ...
        try {
            EtherscanAPI.getInstance().getNormalTransactions(address, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    final List<TransactionDisplay> w = new ArrayList<TransactionDisplay>(ResponseParser.parseTransactions(restring, "Unnamed Address", address, TransactionDisplay.NORMAL,false));
                    if (isAdded()) {
                        ac.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
