...
import rehanced.com.simplenukowallet.activities.AddressDetailActivity;
import rehanced.com.simplenukowallet.activities.SendActivity;
...
import rehanced.com.simplenukowallet.utils.Blockies;
...
import rehanced.com.simplenukowallet.utils.TokenAdapter;
...
public class FragmentDetailOverview extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener, LastIconLoaded {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //display nuko by default
        CurrencyEntry cur = ExchangeCalculator.getInstance().getEtherCurrency();
        ...
        EtherscanAPI.getInstance().getBalance(ethaddress, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    Log.d("response",body);
                    ethbal = new BigDecimal(ResponseParser.parseBalance(body));
                    Log.d("balance",ethbal.toString());
                    token.add(0, new TokenDisplay("Nekonium", "Nuko", ethbal.multiply(new BigDecimal(1000d)), 3, 1, "", "", 0, 0));
...
// dont have token api for now. leave it here
